...
| :--- | :--- | :--- | :--- | :--- |
| **Starter Lamp** | Common | A basic starter lamp for new scavengers. Provides light for 2 days. | 2 Days | 0 |
...
- **Hydraulic Piston**: Rare heavy mechanical actuator produced by powered Industrial facilities (Field Engineering Lvl 2).
- **Logic Core**: Rare programmable electronics core produced by powered Electronic Labs (Field Engineering Lvl 2).
- **Signal Emitter**: Rare advanced transmission module produced by powered Electronic Labs (Field Engineering Lvl 3).
- **Solar Cell**: Rare crafted photovoltaic cell for harvesting sunlight. Used to build solar panels.

## Salvageables (Junk)

| Item | Rarity | Description |
| :--- | :--- | :--- |
| **Broken Radio** | Common | Salvageable electronics from a damaged broadcast unit. |
| **Rusty Tool** | Common | Corroded metal tool. Can be broken down for raw materials. |
| **Cracked Lens** | Common | Optical glass from damaged equipment. |
| **Burnt-Out Motor** | Common | Seized motor housing. Some parts may still be usable. |
