...
- **Personal Light**: [[mechanisms/items|Items]] like the "[[mechanisms/items|Starter Lamp]]" provide a mobile radius of safety but have limited duration.
...
- **Degradation**: Light sources like the [[mechanisms/items|Starter Lamp]] have a limited lifespan (e.g., "1 day of light remaining").
...
- **Refueling**: [[mechanisms/items|Items]] like the "Empty Lamp" require a "Battery" to be crafted into a functional light source.
