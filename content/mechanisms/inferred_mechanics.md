...
## 1. The [[mechanisms/time_and_power|Midnight]] Cycle (The "Toll")
- **Confirmed Drain Rates**: Survival vitals ([[mechanisms/hunger|Hunger]]/[[mechanisms/thirst|Thirst]]) drain by **40% (4 bars)** at [[mechanisms/time_and_power|Midnight]]. 
- **Inferred Power Drain**: Town Power Drain is likely deducted at [[mechanisms/time_and_power|Midnight]].
...
- **Inferred Breach Consequences**: If a breach occurs, is it a direct drain on town power (-10% per enemy?), a destruction of infrastructure (Power Poles), or a reduction in base population?
