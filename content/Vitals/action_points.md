...
- **Restoration**: 
 ...
 - **Consumables**: 
  - **Stimulants**: Restored by **[[Items/Unknown/stim_pack|Stim Packs]]** (+4 AP), **[[Items/Unknown/stim_injector|Stim Injectors]]** (+8 AP), and **[[Items/Unknown/stim_overdrive|Stim Overdrive]]** (+12 AP).
  - **Food & Water**: Consuming **Rations, Water, Salad, and Glowing Mushrooms** restores **+2 AP**. High-tier items like **Nutrient Paste** can restore up to **+3 AP**.
